...
pub struct jawt_X11DrawingSurfaceInfo {
    ...
    pub GetAWTColor: ::std::option::Option<
        unsafe extern "C" fn(
...
fn bindgen_test_layout_jawt_X11DrawingSurfaceInfo() {
    const UNINIT: ::std::mem::MaybeUninit<jawt_X11DrawingSurfaceInfo> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<jawt_X11DrawingSurfaceInfo>(),
        48usize,
        concat!("Size of: ", stringify!(jawt_X11DrawingSurfaceInfo))
    );
    assert_eq!(
        ::std::mem::align_of::<jawt_X11DrawingSurfaceInfo>(),
        8usize,
        concat!("Alignment of ", stringify!(jawt_X11DrawingSurfaceInfo))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(jawt_X11DrawingSurfaceInfo),
            "::",
            stringify!(drawable)
        )
    );
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).colormapID) as usize - ptr as usize },
        24usize,
        concat!(
            "Offset of field: ",
            stringify!(jawt_X11DrawingSurfaceInfo),
            "::",
            stringify!(colormapID)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).GetAWTColor) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(jawt_X11DrawingSurfaceInfo),
            "::",
            stringify!(GetAWTColor)
        )
    );
}
